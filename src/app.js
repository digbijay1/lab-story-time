...
function sweetTooth(
    totalNoofSweets,
    sweetsConsumeByKaren,
    sweetsConsumedInNMeters,
    metersToTravel
  ) {
    let result;
    if (
      Number.isInteger(totalNoofSweets) &&
      Number.isInteger(sweetsConsumeByKaren) &&
      Number.isInteger(sweetsConsumedInNMeters) &&
      Number.isInteger(metersToTravel)
    ) {
      result =
        totalNoofSweets -
        (sweetsConsumeByKaren + sweetsConsumedInNMeters * metersToTravel);
      return result / 2;
    } else {
